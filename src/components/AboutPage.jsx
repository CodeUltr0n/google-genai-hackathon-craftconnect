...
const AboutPage = () => {
  const teamMembers = [
    { name: 'Ketan Chokkara', role: 'Frontend Developer & UI/UX Designer', imageUrl: 'https://i.imgur.com/placeholder.png', description: 'Responsible for architecting and building the user interface, ensuring a seamless and engaging experience for both artisans and customers.' },
    { name: 'Ruchitankshi', role: 'Backend Developer & Database Architect', imageUrl: 'https://i.imgur.com/placeholder.png', description: 'Responsible for building the robust MERN stack backend, managing the MongoDB database, and creating the APIs that power the platform.' },
    { name: 'Sarveesh', role: 'Flutter Developer & App Support', imageUrl: 'https://i.imgur.com/placeholder.png', description: 'Maintains and enhances the mobile application, ensuring smooth user experience and integrating new features.' },
  ];
